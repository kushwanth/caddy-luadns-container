...
- [Automated Maintenance (Renovate)](#automated-maintenance-renovate)
- [License](#license)
...
- **Automated Upstream Tracking**: Renovate continuously monitors upstream Caddy and LuaDNS releases and dispatches review notifications.
